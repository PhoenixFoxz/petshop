...
**PWA** significa **Progressive Web Application** (Aplicativo web Progressivo). Trata-se de uma abordagem para desenvolvimento de aplicativos web que visa características de sites e aplicativos móveis. As PWAs são contruídas com tecnologias web tradicionais (HTML5, CSS e JavaScript) e oferecem uma experiência semelhante à de aplicativos nativos, podendo até mesmo serem instaladas no dispositivo móvel.
