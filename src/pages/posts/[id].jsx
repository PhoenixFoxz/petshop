...
export async function getStaticProps({ params }) {
  ...
  configurada nos links da Lista de Posts. Usamos a desestruturação para obter de forma direta o parâmetro chamado "id".*/
  const { id } = params;
  console.log(id);
...
/* getStaticPaths é obrigatória quando se trata de trabalhar com páginas/rotas dinâmicas, ou seja, que dependem de parâmetros para serem construídas. */
